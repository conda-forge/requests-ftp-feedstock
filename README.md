About requests-ftp-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/requests-ftp-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1847&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/requests-ftp-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `requests-ftp` can be installed with `conda`:
...
```
mamba install requests-ftp
```

It is possible to list all of the versions of `requests-ftp` available on your platform with `conda`:
...
```
mamba search requests-ftp --channel conda-forge
```
...
mamba repoquery search requests-ftp --channel conda-forge

# List packages depending on `requests-ftp`:
mamba repoquery whoneeds requests-ftp --channel conda-forge

# List dependencies of `requests-ftp`:
mamba repoquery depends requests-ftp --channel conda-forge
```
